    ...
    <div className={styles.stats}>
      <div className={styles['stats-title']}>
        <h1 style={{ fontWeight: 'bold' }}>
          이번 <span>{toggle === 'week' ? '주' : '달'}</span> 운동 통계
        </h1>
      ...
      {!mobile ? (
              ...
              <Container className={styles['stats-chart']}>
                <Container className={styles['chart-title']}>
                  <Container className={styles['title-container']}>
                    <h2>
                      이번 {toggle === 'week' ? '주' : '달'} <span>칼로리</span> 소모량
                    </h2>
                    <h5>
                  ...
                  <Container className={styles['title-container']}>
                    <div className={styles['title-dropdown']}>
                      <div className={styles['title']}>
                        <h2>
                          이번 {toggle === 'week' ? '주' : '달'} <span>{keyMap[selectMenu]}</span>{' '}
                          성장 추이
                        </h2>
                        <h5>
            ...
            <div className={styles['shadow-overlay']}>
              <Container className={styles['stats-chart-side']}>
                <Container className={styles['chart-title']}>
                  <Container className={styles['title-container']}>
                    <h2>
                      이번 {toggle === 'week' ? '주' : '달'} 운동 <span>트렌드</span>
                    </h2>
                    <h5>{`이번 ${toggle === 'week' ? '주는' : '달은'} ${activityTop}을 가장 많이 했어요`}</h5>
                  </Container>
                </Container>
                ...
                <Container className={styles['chart-title']}>
                  <Container className={styles['title-container']}>
                    <h2>
                      이번 {toggle === 'week' ? '주' : '달'} 운동 <span>퍼포먼스</span>
                    </h2>
                    <h5>
              ...
              <Container className={styles['stats-chart']}>
                <Container className={styles['chart-title']}>
                  <Container className={styles['title-container']}>
                    <h2>
                      이번 {toggle === 'week' ? '주' : '달'} <span>운동 퍼포먼스</span> 로그
                    </h2>
                    <h5>
        ...
        <>
          ...
          <Container className={styles['chart-title']}>
            <Container className={styles['title-container']}>
              <h2>
                이번 {toggle === 'week' ? '주' : '달'} <span></span> 성장 추이
              </h2>
              <h5>
          ...
          <Container className={styles['chart-title']}>
            <Container className={styles['title-container']}>
              <h2>이번 {toggle === 'week' ? '주' : '달'} 운동 트렌드</h2>
              <h5>{`이번 ${toggle === 'week' ? '주는' : '달은'} ${activityTop}을 가장 많이 했어요`}</h5>{' '}
            </Container>
          </Container>
          ...
          <Container className={styles['chart-title']}>
            <Container className={styles['title-container']}>
              <h2>이번 {toggle === 'week' ? '주' : '달'} 운동 퍼포먼스</h2>
              <h5>
          ...
          <Container className={styles['chart-title']}>
            <Container className={styles['title-container']}>
              ...
              <h5>이번 {toggle === 'week' ? '주' : '달'} 운동의 더 상세한 데이터를 볼 수 있어요</h5>
            </Container>
          </Container>
          <Card>
            <Container className={styles['stats-logs']}>
